...
def get_loader(args):
    if args.dset == 's2m':
        ...
        s_test = datasets.ImageFolder(root=os.path.join(args.data_path, 'sydigits', 'trainset'),
                                      transform=tr)  # Does not have a testset
        ...
        s_test = datasets.ImageFolder(root=os.path.join(args.data_path, 'sysigns', 'trainset'),
                                      transform=tr)  # Does not have a testset
