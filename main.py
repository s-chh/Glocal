...
def main(args):
    ...
    if args.method == 'src':
        ...
        solver.dann()
    elif args.method == 'dcm':
        solver.dcm()
    elif args.method == 'gan1':
        solver.gan1()
    elif args.method == 'gan2':
        solver.gan2()
...
def update_args(args):
    ...
    args.model_path = os.path.join(args.model_path, args.dset, args.alignment, args.method)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--alignment', type=str, default='none', choices=['none', 'global', 'glocal'])
    parser.add_argument('--method', type=str, default='src', choices=['src', 'dann', 'dcm', 'gan1', 'gan2'])
